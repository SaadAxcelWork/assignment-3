...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
<<<<<<< HEAD
    total_scores = scores_real.shape[0]

    loss = 0.5 * ((scores_real - 1).square() + scores_fake.square()) / total_scores
=======
    # total_scores = scores_real.shape[0]
...
def ls_generator_loss(scores_fake):
    ...
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
<<<<<<< HEAD
    total_scores = scores_fake.shape[0]
    loss = np.sum(0.5 * (scores_fake - 1) ** 2) / total_scores
=======
